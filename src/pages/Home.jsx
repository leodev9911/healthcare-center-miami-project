     ...
     <section className="relative w-full flex flex-col items-center gap-10 mb-28">
      ...
      <section className="flex flex-col gap-8 items-center">
        <div className="w-full flex flex-col lg:flex-row items-center justify-between flex-grow gap-8">
          <img  className="lg:w-[50%] h-auto flex-grow" src={servicesImages} alt="Services image" />
          <div className="lg:w-[50%] flex flex-col items-center text-center mt-10 flex-grow">
            <h2 className="text-2xl xl:text-5xl font-extrabold mb-4 text-colors-pageGray">Servicios DOT</h2>
            <p className="text-sm xl:text-xl mb-12">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut </p>
          </div>
        </div>
        <ContactButton text='Ver Más' />
      </section>   
