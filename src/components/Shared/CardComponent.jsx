...
export default function Card({ 
  ...
  return (
    <div className={`card flex ${location.pathname === '/' ? 'lg:w-[20%] flex-col px-2' : 'lg:w-auto flex-row justify-around px-6'} lg:flex-col lg:flex-grow gap-4 items-center py-4 rounded-br-3xl text-center bg-colors-pageWhite`}>
